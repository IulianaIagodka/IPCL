...
| ADR-003 security (legacy) | Алр 003 `…c745` **RUNNING** | `cursor/implement-adr-003-security-c745` | [#6](https://github.com/IulianaIagodka/IPCL/pull/6) DRAFT | **CONFLICT** vs #11 — tip has **0 unique commits**; pause / close after #11 |
